...
@section('main')
    <div class="space-y-8">
        <h2 class="text-3xl font-bold text-gray-800">Ringkasan Laporan</h2>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            <div class="bg-white p-6 rounded-xl shadow-lg border border-gray-200 flex items-center space-x-4">
                ...
                <div>
                    <h3 class="text-lg font-semibold text-gray-700">Total Pesanan Selesai</h3>
                    <p class="text-4xl font-bold text-green-600">{{ $orderCount }}</p>
            ...
            <div class="bg-white p-6 rounded-xl shadow-lg border border-gray-200 flex items-center space-x-4">
                ...
                <div>
                    ...
                    <p class="text-4xl font-bold text-blue-600">Rp{{ number_format(125000000, 0, ',', '.') }}</p>
                    <p class="text-sm text-gray-500">Periode Tahun Ini</p>
                </div>
            </div>
            ...
            <div class="bg-white p-6 rounded-xl shadow-lg border border-gray-200 flex items-center space-x-4">
                ...
                <div>
                    <h3 class="text-lg font-semibold text-gray-700">Teknisi Aktif</h3>
        ...
        <div class="bg-white p-8 rounded-xl shadow-lg border border-gray-200">
            <h3 class="text-2xl font-bold text-gray-800 mb-6">Laporan Detail</h3>
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                <a href="{{ route('admin.report.orders') }}" class="p-6 bg-gray-50 hover:bg-gray-100 rounded-lg shadow-sm transition-colors duration-200 flex items-start space-x-4 group">
                    <div class="text-blue-500 group-hover:text-blue-700 transition-colors duration-200">
                        <i class="fas fa-file-invoice fa-2x"></i>
                    </div>
                    <div>
                        <h4 class="font-semibold text-lg text-gray-800">Laporan Pesanan</h4>
                        <p class="text-sm text-gray-500">Lihat detail pesanan berdasarkan status dan periode.</p>
                    </div>
                </a>
                
                <a href="{{ route('admin.report.revenue') }}" class="p-6 bg-gray-50 hover:bg-gray-100 rounded-lg shadow-sm transition-colors duration-200 flex items-start space-x-4 group">
                    <div class="text-green-500 group-hover:text-green-700 transition-colors duration-200">
                        <i class="fas fa-chart-line fa-2x"></i>
                    </div>
                    <div>
                        <h4 class="font-semibold text-lg text-gray-800">Laporan Pendapatan</h4>
                        <p class="text-sm text-gray-500">Analisis pendapatan berdasarkan waktu dan jenis jasa.</p>
                    </div>
                </a>
                
                <a href="{{ route('admin.report.technicians') }}" class="p-6 bg-gray-50 hover:bg-gray-100 rounded-lg shadow-sm transition-colors duration-200 flex items-start space-x-4 group">
                    <div class="text-purple-500 group-hover:text-purple-700 transition-colors duration-200">
                        <i class="fas fa-users-cog fa-2x"></i>
                    </div>
                    <div>
                        <h4 class="font-semibold text-lg text-gray-800">Laporan Performa Teknisi</h4>
                        <p class="text-sm text-gray-500">Pantau kinerja masing-masing teknisi.</p>
                    </div>
                </a>
                
                <a href="{{ route('admin.report.popular_services') }}" class="p-6 bg-gray-50 hover:bg-gray-100 rounded-lg shadow-sm transition-colors duration-200 flex items-start space-x-4 group">
                    <div class="text-orange-500 group-hover:text-orange-700 transition-colors duration-200">
                        <i class="fas fa-fire fa-2x"></i>
                    </div>
                    <div>
                        <h4 class="font-semibold text-lg text-gray-800">Laporan Jasa Terpopuler</h4>
        ...
        {{-- Latest Orders Table --}}
        <div class="bg-white p-8 rounded-xl shadow-lg border border-gray-200">
            <h3 class="text-2xl font-bold text-gray-800 mb-6">10 Pesanan Terakhir</h3>
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap font-medium text-gray-900">Dewi Lestari</td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">Perbaikan AC</td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-green-100 text-green-800">Selesai</span>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">2025-07-27</td>
                        </tr>
                        <tr>
                            <td class="px-6 py-4 whitespace-nowrap">#003</td>
                            <td class="px-6 py-4 whitespace-nowrap font-medium text-gray-900">Fajar Putra</td>
