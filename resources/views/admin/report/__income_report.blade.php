...
@section('main')
    <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-100 p-6">
        <div class="bg-white p-6 rounded-lg shadow-md">
            <h2 class="text-2xl font-bold mb-4 text-gray-800">Laporan Detail Pendapatan</h2>
            ...
            <form action="#" method="GET" class="mb-6 bg-gray-50 p-4 rounded-lg shadow-sm flex flex-wrap gap-4 items-end">
                ...
                <div class="flex items-end gap-2">
                    ...
                    @if (request()->hasAny(['start_date', 'end_date']))
                        <a href="{{ route('adminreport.revenue') }}" class="text-sm text-blue-500 hover:underline">Reset</a>
                    @endif
                </div>
            </form>
            ...
            <div class="mb-6 bg-blue-50 p-4 rounded-lg shadow-sm">
                <h3 class="text-xl font-semibold text-blue-800 mb-2">Total Pendapatan Terfilter:</h3>
                <p class="text-3xl font-bold text-blue-800">Rp 12.500.000</p> {{-- Dummy Total. Ganti dengan data aktual --}}
                {{-- <p class="text-3xl font-bold text-blue-800">Rp {{ number_format($totalRevenue, 0, ',', '.') }}</p> --}}
            </div>
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Tanggal/Bulan</th>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right">3</td>
                            <td class="px-6 py-4 whitespace-nowrap text-right">Rp 450.000</td>
                        </tr>
                        <tr>
                            <td class="px-6 py-4 whitespace-nowrap">2025-07-28</td>
                            <td class="px-6 py-4 whitespace-nowrap">Perbaikan AC</td>
                            <td class="px-6 py-4 whitespace-nowrap text-right">1</td>
                            <td class="px-6 py-4 whitespace-nowrap text-right">Rp 200.000</td>
                        </tr>
                        <tr>
                            <td class="px-6 py-4 whitespace-nowrap">2025-07</td>
                            <td class="px-6 py-4 whitespace-nowrap">Total Bulan Ini</td>
                            <td class="px-6 py-4 whitespace-nowrap text-right font-bold">50</td>
                            <td class="px-6 py-4 whitespace-nowrap text-right font-bold">Rp 12.500.000</td>
                        </tr>
                        {{-- @empty
                            <tr>
