    ...
    <div class="bg-white p-8 rounded-lg shadow-md w-full max-w-sm">
        ...
        <form action="{{ route('auth.proses') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="email" id="email" name="email" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" placeholder="Masukkan email Anda">
            </div>
            <div class="mb-6">
