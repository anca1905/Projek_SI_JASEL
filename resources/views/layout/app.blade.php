...
<body class="bg-gray-50 text-gray-800">
    <div class="flex h-screen overflow-hidden antialiased">
        <aside class="w-64 bg-white text-gray-800 border-r border-gray-200 shadow-lg flex flex-col p-4 transition-all duration-300 ease-in-out">
                        ...
                        @if (Auth::user()->role == 'admin')
                            ...
                            <li>
                                <a href="{{ route('admin.report.index') }}"
                                    ...
                                    <svg class="w-5 h-5 mr-3" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd" d="M2 5a2 2 0 012-2h12a2 2 0 012 2v10a2 2 0 01-2 2H4a2 2 0 01-2-2V5zm15 2h-4a1 1 0 00-1 1v2a1 1 0 001 1h4a1 1 0 001-1V8a1 1 0 00-1-1z" clip-rule="evenodd"></path>
                                        <path fill-rule="evenodd" d="M12 11H8a1 1 0 00-1 1v4a1 1 0 001 1h4a1 1 0 001-1v-4a1 1 0 00-1-1z" clip-rule="evenodd"></path>
                                    </svg>
                                    Laporan
                                </a>
                            </li>
                        ...
                        @if (Auth::user()->role == 'teknisi')
                            ...
                            <li>
                                <a href="{{ route('teknisi.my_orders') }}"
                                    ...
                                    <svg class="w-5 h-5 mr-3" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M2 4a1 1 0 011-1h2a1 1 0 011 1v12a1 1 0 01-1 1H3a1 1 0 01-1-1V4zM8 4a1 1 0 011-1h2a1 1 0 011 1v12a1 1 0 01-1 1H9a1 1 0 01-1-1V4zM14 4a1 1 0 011-1h2a1 1 0 011 1v12a1 1 0 01-1 1h-2a1 1 0 01-1-1V4z"></path>
                                    </svg>
                                    Pesanan Saya
                                </a>
                            </li>
                        ...
                        @can('costumer')
                            ...
                            <li>
                                <a href="{{ route('costumer.order_history') }}"
                                    ...
                                    <svg class="w-5 h-5 mr-3" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M2 4a1 1 0 011-1h2.586a1 1 0 01.707.293L10 6.586V15a2 2 0 01-2 2H4a2 2 0 01-2-2V4zM11 11h3a1 1 0 011 1v3a1 1 0 01-1 1h-3a1 1 0 01-1-1v-3a1 1 0 011-1z"></path>
            ...
            <div class="mt-8 pt-4 border-t border-gray-200">
                <form action="{{ route('auth.logout') }}" method="POST">
                    ...
                    <button type="submit"
                        ...
                        <svg class="w-5 h-5 mr-3" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" d="M3 3a1 1 0 00-1 1v12a1 1 0 102 0V4a1 1 0 00-1-1zm10.707 3.293a1 1 0 00-1.414 1.414L14.586 10l-2.293 2.293a1 1 0 101.414 1.414L17.414 10l-3.707-3.707zM17 10a1 1 0 00-1 1v2a1 1 0 102 0v-2a1 1 0 00-1-1z" clip-rule="evenodd"></path>
                        </svg>
                        Logout
                    </button>
                </form>
        ...
        <main class="flex-1 flex flex-col overflow-hidden">
            <header class="bg-white text-gray-800 flex justify-between items-center px-6 py-4 shadow-lg border-b border-gray-200">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <img src="https://ui-avatars.com/api/?name={{ urlencode(Auth::user()->name ?? 'Admin') }}&background=E0E7FF&color=4338CA"
                        alt="User Avatar" class="rounded-full w-10 h-10 object-cover border-2 border-blue-500 shadow-sm">
                </div>
            </header>
